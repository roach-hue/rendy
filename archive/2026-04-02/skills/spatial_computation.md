...
# ceiling_height_mm: ParsedDrawings.section에서 추출, 없으면 fallback
if parsed_drawings.section:
    space_data["floor"]["ceiling_height_mm"] = {
        "value": parsed_drawings.section.ceiling_height_mm,
        "confidence": parsed_drawings.section.confidence,
        "source": parsed_drawings.section.source
    }
else:
    space_data["floor"]["ceiling_height_mm"] = {
        "value": 3000, "confidence": "low", "source": "default"
    }
```
...
space_data = {
    ...
    "floor": {
        ...
        "ceiling_height_mm": {"value": 3000, "confidence": "high", "source": "dxf_dimension"}
    },
